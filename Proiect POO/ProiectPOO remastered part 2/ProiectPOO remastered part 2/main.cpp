...
void afisare_cuvant_litere_lipsa(cuvinte Cuvinte[120], int contor_cuvinte, char litera, bool corect)
{
	int dimensiune, i;
...
void spanzuratoare_int_main()
{
	...
	while (contor_cuvinte <= 119 && litera != 27 && decizie != 27)
	{
		...
		cout << endl << endl;
		afisare_cuvant_litere_lipsa(Cuvinte, contor_cuvinte, litera, corect);
		cout << endl << endl;
